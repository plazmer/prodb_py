...
app = Bottle()
r = Redis(decode_responses=True) # все значения будут автоматически 
                                 # переведены в юникод строки
...
@app.get('/')
def index():
    counter = r.incr("visitors") # счетчик, увеличивает число, сохраненное в ключе, на единицу.
                                   # Если ключ не существует, он устанавливается в 0 перед выполнением операции.
